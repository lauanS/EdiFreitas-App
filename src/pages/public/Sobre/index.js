    ...
    return (
      <div>
        ...
        <div className="container" style={{paddingTop: "80px"}}>
          <img className="imagem" src={donaEdi}/>
          <h5>Quem Somos</h5>
